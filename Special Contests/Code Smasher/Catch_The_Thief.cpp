/**
 * CODER=> xavierbeast68
 * Problem : Catch The Thief -> Code Smasher Coding Contest (Codechef)
 * Date : 13-11-2022
 * URL : https://www.codechef.com/CDSM2022/problems/CATTHF
...
void solve()
{
    ...
    if ((t % m) % 2 == 0)
    {
        cout << (t / m) + 1 << " " << (t % m) + 1 << endl;
    }
    else
    {
        cout << (t / m) + 1 << " " << m - (t % m) << endl;
    }
}
