/**
 * CODER=> xavierbeast68
 * Problem : Distinct Sequence -> Codechef Starters 69
 * Date : 14-12-2022
 * URL : https://www.codechef.com/START69C/problems/DISTINCTSEQ
...
void solve()
{
    ...
    if(vec_zero.size()==0 || vec_one.size()==0)
    {
        println(-1);
        return;
    }
