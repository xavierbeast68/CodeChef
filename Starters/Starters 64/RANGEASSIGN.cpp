/**
 * CODER=> xavierbeast68
 * Problem : Range Assign, Number of Distinct Elements Minimize (Codechef Starters 64)
 * Date : 09-11-2022
 * URL : https://www.codechef.com/START64C/problems/RANGEASSIGN
...
void solve()
{
    ...
    FOR(i, 0, n)
    {
        ...
        {
            int ind = find(count.begin(), count.end(), x) - count.begin();
            count2.push_back(count2[ind]);
            count.push_back(x);
            ii = count2[ind];
        }
        else
