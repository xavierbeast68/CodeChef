/**
 * CODER=> xavierbeast68
 * Problem : Pet Store -> Codechef Starters 71
 * Date : 28-12-2022
 * URL : https://www.codechef.com/START71C/problems/PETSTORE
...
void solve()
{
	...
	else
	{
		for (auto& i : mp)
		{
			if ((i.second) % 2 == 1)
			{
				println("No");	// cout<<"No"<<endl;
				return;
			}
		}
		println("Yes");	// cout<<"Yes"<<endl;
	}
	*/
